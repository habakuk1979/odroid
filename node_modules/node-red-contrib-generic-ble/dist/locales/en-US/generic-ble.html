<script type="text/x-red" data-help-name="Generic BLE in"> <p>Emits read characteristic values and/or notified characteristic values. Accepts connect/disconnect requests as well.</p>
<h3>Outputs</h3>
<p>
...
</p> </script> <script type="text/x-red" data-help-name="Generic BLE out"> <p>
...
</dl> </script> <script type="text/x-red" data-help-name="Generic BLE"> <p>
