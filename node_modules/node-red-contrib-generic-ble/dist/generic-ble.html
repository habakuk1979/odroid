<script type="text/x-red" data-template-name="Generic BLE in"> <div class='form-row'>
  ...
  </div> </script> <script type="text/javascript"> RED.nodes.registerType('Generic BLE in', {
    category: 'network',
    color: '#4d94ff',
    defaults: {
      name: { value: '' },
  ...
  }); </script> <script type="text/x-red" data-template-name="Generic BLE out"> <div class='form-row'>
    <label for='node-input-name'>
      <i class='fa fa-tag'></i>
      <span data-i18n='node-red:common.label.name'></span>
    </label>
  ...
  <div class="form-row node-input-genericBle">
    <label for="node-input-bleenv">
      ...
      <span data-i18n="generic-ble.label.genericBle"></span></label>
    <input type="text" id="node-input-genericBle">
  </div> </script> <script type="text/javascript"> RED.nodes.registerType('Generic BLE out', {
    category: 'network',
    color: '#4d94ff',
    defaults: {
      name: { value: '' },
  ...
  }); </script> <script type="text/x-red" data-template-name="Generic BLE"> <div class="form-row">
    <label>&nbsp;</label>
